...
.profile-account__dropdown.show {
    opacity: 1;
    visibility: visible;
    transform: translateY(0);
}

.profile-account__item {
    display: block;
    padding: 10px 14px;
...
<header class="profile-header">
    <div class="profile-header__inner">
        ...
        <div class="profile-account">
            <button class="profile-account__trigger" onclick="toggleAccount()">
...
<section class="profile-hero">
    <div class="profile-hero__card">
        ...
        <div class="profile-hero__stats">
            <div>
                <div class="profile-stat__number">{{ count($posts ?? []) }}</div>
...
function toggleAccount() {
    document.querySelector('.profile-account__dropdown')?.classList.toggle('show');
}
</script>
